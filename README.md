...
This repo serves as API endpoint for [Hello React Front-End](https://github.com/JoyTaribagshaw/hello-react-front-end) project.
...
> cd my-folder
> git clone https://github.com/JoyTaribagshaw/hello-rails-back-end.git
Setup database:
